package zhou.com.fulicenter.controller.adapter;
...
public class CategoryAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpand, View view, ViewGroup viewGroup) {
        ...
        CategoryGroupBean group = mGroupList.get(groupPosition);
        if (group != null) {
            ImageLoader.downloadImg(mContext, holder.mIvGroupThumb, group.getImageUrl());
            holder.mTvGroupName.setText(group.getName());
            holder.mIvIndicator.setImageResource(isExpand ? R.mipmap.expand_on : R.mipmap.expand_off);
        }
        return view;
    }
